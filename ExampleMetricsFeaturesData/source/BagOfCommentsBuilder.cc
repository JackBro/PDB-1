...
BagOfCommentsBuilder :: BagOfCommentsBuilder (const string &myNameIn, PDBQueryExecutorPtr myAggregatorIn, int dictionarySizeIn) {
	myName = myNameIn;
...
PDBFeatureBuilder &BagOfCommentsBuilder :: operator = (PDBFeatureBuilderPtr &copyMeIn) {
	BagOfCommentsBuilder *copyMe = dynamic_cast<BagOfCommentsBuilder *> (copyMeIn.get ());
...
bool BagOfCommentsBuilder :: runsOnThisPDBData (PDBData &checkMe) {
...
PDBFeatureTypePtr BagOfCommentsBuilder :: buildFeature (PDBData &fromMe, bool &wasError, string &) {
...
const string &BagOfCommentsBuilder :: getFeatureName () {
	return myName;
}
...
void *BagOfCommentsBuilder :: serialize(void *toHere, size_t &) {
        return toHere;
}

void *BagOfCommentsBuilder :: deSerialize(void *fromHere, size_t &) {
        return fromHere;
}
